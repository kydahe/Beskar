...
class LatencyModel:
  ...
  def get_latency(self, sender_id = None, recipient_id = None, message_size=10000):
    """
    ...
    if self.latency_model == 'cubic':
      ...
      latency = min_latency + ((a / x**3) * (min_latency / unit)) * (message_size/10000)

    elif self.latency_model == 'deterministic':
      return min_latency * (message_size/10000)
