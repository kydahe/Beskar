...
class Agent:
  ...
  def sendMessage (self, recipientID, msg, delay = 0, tag = "communication", msg_size=10000):
    self.kernel.sendMessage(self.id, recipientID, msg, delay = delay, tag = tag, msg_size=msg_size)
